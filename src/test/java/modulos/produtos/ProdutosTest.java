...
public class ProdutosTest {
    @Test
    @DisplayName("Não é permetido registrar um produto com valor igual a zero")
    public  void testNaoEPermitidoRegistrarProdutoComValorIgualaZero(){
        //Abrir o navegador
        System.setProperty("webdriver.chrome.driver", "C:\\DTAR\\drivers\\chromedriver_win32\\chromedriver.exe");
